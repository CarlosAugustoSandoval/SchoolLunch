...
const Categories:ICategory[] = [
  ...
  },
  {
    ...
    status: 'Active',
    image: 'https://www.zamorano.edu/wp-content/uploads/2016/11/jugos_fresco_salud_mokana_nutricion-copia.jpg',
    products: [
      {
        id: 3,
        code: '003',
  ...
  },
  {
    ...
    name: 'Paquetes',
    status: 'Active',
    image: 'https://m.media-amazon.com/images/I/51vHb3I33cL.jpg',
    products: [
      {
        id: 1,
        code: '001',
  ...
  },
  {
    id: 1,
    code: '004',
    name: 'Bebidas artificiales',
    status: 'Active',
    image: 'https://www.periodicodebatepolitico.com.mx/wp-content/uploads/2019/10/refrescos.png',
    products: [
      {
        id: 1,
        code: '001',
